...
// import 'package:quds_server/hotreload/quds_server_hotreload.dart';
...
// const String cliTitle = '[Quds Server / 0.0.1 - Beta]';
...
//   var commandRunner = CommandRunner<bool>('quds_server', '$cliTitle - CLI Tool')
...
//         spawner.getProjectDependencyVersion('quds_server');

//     if (projectBonesAPIVersions == null) {
//       throw StateError(
//           'Target project (`${spawner.projectPackageName}`) is not using package `quds_server`: $directory');
//     }
...
//       var resource =
//           Resource('package:quds_server/src/templates/api_app_sample.tar.gz');
...
//       '     $defaultTemplate\n\n'
//       'See also:\n'
//       '  https://pub.dev/packages/quds_server#cli',
//     );
